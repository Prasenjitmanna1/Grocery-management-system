...
<body>
    <div class="main-div" id="maindiv">
        <div class="container-fluid mt-1">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h3 class="m-0 table-heading">Purchase </h3>
                </div>
            </div>
                        ...
                        <div class="container">
                            <div class="row">
                               ...
                               if(isset($_POST['submit'])){
                                   ...
                                   $sql = "SELECT * from items_cat where item_code like '%$str%' or item_name like  '%$str%'";
                                ...
                                <div class="col-md-4">
                                    <form method="post" action="purchase-cart.php">
...
$count=0;
                    ...
                    if(isset($_SESSION['pcart'])){ 
                        ?>
                            <a href="purchase-cart-view.php" class="btn border border-success m-2 text-Success">
